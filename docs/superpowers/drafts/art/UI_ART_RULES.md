...
- **Costume Guide cover** (`Assets/Art/UI/Resources/Investigation/refbook_cover_culture.png`, **400 x 560**, next to and like `refbook_cover_currency.png` and the other reference-book covers; drop-in): a closed book cover with a simple garment motif (a hat and a collar), **no title**. The game shows the book's name, and the cover on the book's tile and at the top of its window. Ask ChatGPT for the tall size and Claude trims and scales it.
