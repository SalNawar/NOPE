...
{
    private static DesktopEscape Resolve(bool field = false, bool startMenu = false, bool drag = false) =>
        DesktopEscapeRule.Resolve(new DesktopEscapeState(field, startMenu, drag));
