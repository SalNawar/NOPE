...
public static partial class WorldContentGenerator
{
    ...
    [Serializable] private sealed class AgencyData { public string name; public string programme; public string firstDate; }

    /// <summary>The agency block's content (its fields verbatim).</summary>
    private static AgencyContent BuildAgency(AgencyData a) =>
        new AgencyContent { name = a.name, programme = a.programme, firstDate = a.firstDate };
