...
public static class ContentLibraryValidator
{
    ...
    /// nations), rules no place of the day can break, premades (pooled or
    /// forced) whose claim or true place is outside the day's world, forced
    /// slots beyond the queue, a premade forced twice, a forced premade in the
    /// first half of a day with rules (a warning: it takes a slot a guaranteed
    /// violator could need), and a day allowing dress tells without a Costume Guide.
    /// </summary>
