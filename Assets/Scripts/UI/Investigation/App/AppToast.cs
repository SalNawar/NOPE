...
/// time or once Open is clicked. It lives on the desktop, not in the app, so
...
public sealed class AppToast : MonoBehaviour
{
    ...
    /// <summary>Shows <paramref name="line"/> for <paramref name="seconds"/> (unscaled); Open runs <paramref name="open"/>.</summary>
