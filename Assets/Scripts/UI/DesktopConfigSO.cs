...
/// order, the drop's overlap share), the double-click, and the Internet's
/// caps (the news back issues, the browser's history). Created and assigned
/// by Tools > TimeDesk > Build Office UI
/// (Assets/Data/Config/Desktop_Default.asset). The builder reads the sizes
